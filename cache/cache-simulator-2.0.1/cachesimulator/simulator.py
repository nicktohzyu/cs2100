...
class Simulator(object):
    ...
    def display_addr_refs(self, refs, table_width):
        ...
        table = Table(
            num_cols=len(REF_COL_NAMES), width=table_width, alignment='center')
        ...
        for ref in refs:
            ...
            table.rows.append((
                ref.word_addr,
                BinaryAddress.prettify(ref.bin_addr, BITS_PER_GROUP),
                BinaryAddress.prettify(ref_tag, BITS_PER_GROUP),
                BinaryAddress.prettify(ref_index, BITS_PER_GROUP),
                BinaryAddress.prettify(ref_offset, BITS_PER_GROUP),
                ref.cache_status))
